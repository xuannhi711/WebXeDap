...
namespace WebXeDap.Areas.Admin.Controllers
{
    ...
    public class ThongKeController : Controller
    {
        ...
        public async Task<IActionResult> Index(DateTime? startDate, DateTime? endDate, string reportType)
        {
        ...
        private async Task<List<DailyRevenueData>> GetRevenueData(DateTime startDate, DateTime endDate, string reportType)
        {
            ...
            {
                case "monthly":
                    query = from hd in _context.Hoadon
