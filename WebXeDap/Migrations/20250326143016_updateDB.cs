...
namespace WebXeDap.Migrations
{
	...
	public partial class updateDB : Migration
	{
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateIndex(name: "IX_Anhs_MaSP", table: "Anhs", column: "MaSP");
		...
		{
			migrationBuilder.DropTable(name: "Anhs");
			...
			migrationBuilder.DropTable(name: "Baohanhs");
			...
			migrationBuilder.DropTable(name: "Giohangs");
			...
			migrationBuilder.DropTable(name: "Khuyenmais");

			migrationBuilder.DropTable(name: "Loais");

			migrationBuilder.DropTable(name: "Nhacungcaps");
		}
	}
}
